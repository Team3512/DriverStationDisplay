/* This class has been modified from the original HTTP implementation to
 * maintain the TCP socket connection throughout the lifetime of the object.
 * This reduces latency in the HTTP stream.
 */
...
#ifndef SFML_CONT_HTTP_HPP
#define SFML_CONT_HTTP_HPP
...
///
////////////////////////////////////////////////////////////
class SFML_NETWORK_API ContHttp : NonCopyable
{
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    ContHttp(const std::string& host, unsigned short port = 0);
    ...
    ///
    ////////////////////////////////////////////////////////////
    Response startStream(const Request& request);
